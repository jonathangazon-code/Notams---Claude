...
namespace ICAO_CSV
{
	public partial class MainForm
	{
		...
		private void BuildAdminTab()
		{
			...
			Button save = new Button { Tag = "dispose", Top = 176, Left = 20, Width = 100, Height = 30, Text = "Save" };
			save.Click += delegate
			{
			...
			_adminStatus = new Label { Tag = "dispose", Top = 184, Left = 130, AutoSize = true, ForeColor = Color.Gray, Text = "" };
