...
| `MainForm.Conflict.cs` | Conflict tab — cross-references Kept, impact-classified NOTAMs against `FlightSchedule` (±2h STD/STA window overlap), one HTML section per impact code with airport card + matching flights + full NOTAM text |
